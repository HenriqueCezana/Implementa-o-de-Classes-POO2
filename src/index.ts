...
const contas: Array<Conta> = [
    new ContaCorrente(cliente1, 500, 15, 300, 5),
    new Poupanca(cliente2, 1000, 1.5),
    new ContaRemunerada(cliente3, 800, 10, 400, 4, 2),

    new ContaCorrente(cliente4, 200, 12, 150, 6),
    new Poupanca(cliente5, 1500, 1.2),
    new ContaRemunerada(cliente6, 1200, 20, 500, 3, 1.8)
];
...
const aplicacoes: Array<IAplicacao> = [];

contas.forEach(conta => {
    if (conta instanceof Poupanca || conta instanceof ContaRemunerada) {
